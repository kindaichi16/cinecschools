	...
	<div class="container">
		<div class="row">
			<div class="col-sm-4">
				...
				<?php if( get_theme_mod( 'edu_newsletter_from_cinec' ) == '1' ) { 
					$newsletter_t = __('NEWSLETTER', 'cinec_school_theme');
					$cinec_nl_url = "http://www.cinec.ca/newsletter/";
					$image_src = 'http://www.cinec.ca/images/nl_thumb/019.png';
					
					echo'<div class="index-content-category">
					<!-- Print a link to this category --> 
					<a href="'.$cinec_nl_url.'" title="'.$newsletter_t.'">'.$newsletter_t.'
					<span class="pull-right glyphicon glyphicon-play"></span></a></div>
					<div class="index-content-box"><a href="'.$cinec_nl_url.'" rel="bookmark" title="'.$newsletter_t.'">
					<img src="'.$image_src.'" width="100%" class="img-responsive thumb-newsletter center-block" /></a></div>';
				...
				<div class="index-content-box">
					...
					<div class="index-content-list">
						<div class="row mobile-content-padding">
							<div class="col-sm-4 hidden-xs"> <a href="<?php the_permalink(); ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>">
								<?php check_thumbnail(70); ?>
								</a> </div>
							<div class="col-xs-3 visible-xs"><a href="<?php the_permalink(); ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>">
								<?php check_thumbnail(160); ?>
								</a></div>
							<div class="col-xs-9 col-sm-8 index-content-list-text margin-l-10">
								<p>
